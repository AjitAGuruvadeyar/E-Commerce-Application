...
const navigate=useNavigate();
  const handleSubmit = async (e) => {
    ...
    const response = await axios.post(`http://localhost:8080/api/v1/address/addContact?addressId=${addressId}`,formData,{
      headers:{
    ...
    <div className="w-full flex justify-center items-center mb-4">
        ...
        <div className="w-full flex justify-center items-center mb-4">
          <select
            ...
            placeholderText={"Enter the priority"}
            value={priority}
          >
             <option value="">-- Select Contact Priority--</option>
